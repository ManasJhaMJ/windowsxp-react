...
function StartMenu({ setShowVideoPlayer, setShowImageViewer, setShowAudioPlayer, setLogoff, setClickCount }) {
        ...
        <>
            <div id='startMenu'>
                <div className='inner-start'>
                    ...
                    <a target="_blank" href="https://www.youtube.com/shorts/GMn4pdaUJs8&mute=0">
